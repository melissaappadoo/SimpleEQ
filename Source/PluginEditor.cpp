...
void myLookAndFeel::drawRotarySlider(juce::Graphics& g, int x, int y, int width, int height, float sliderPosProportional, float rotaryStartAngle, float rotaryEndAngle, juce::Slider& slider)
{
    ...
    if (auto* rswl = dynamic_cast<RotartSliderWithLabels*>(&slider))
    {
...
void myLookAndFeel::drawToggleButton(juce::Graphics& g, juce::ToggleButton& toggleButton, bool shouldDrawButtonAsHighlighted, bool shouldDrawButtonAsDown)
{
    using namespace juce;
...
//==============================================================================
void RotartSliderWithLabels::paint(juce::Graphics& g)
{
    using namespace juce;
...
juce::Rectangle<int> RotartSliderWithLabels::getSliderBounds() const
{
...
juce::String RotartSliderWithLabels::getDisplayString() const
{
...
void PathProducer::process(juce::Rectangle<float> fftBounds, double sampleRate)
{
    ...
    */
    ...
    while (leftChannelFFTDataGenerator.getNumAvailabkeFFTDataBlocks() > 0)
    {
...
void ResponseCurveComponent::paint(juce::Graphics& g)
{
    ...
    {
        double mag = 1.f;
        auto freq = mapToLog10(double(i) / double(w), 20.0, 20000.00);
